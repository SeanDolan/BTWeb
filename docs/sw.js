...
const CACHE = `btweb-controller-v9:${self.registration.scope}`;
const ASSETS = ['./', './index.html', './style.css', './controller.html', './controller/app.js', './controller/ble.js', './controller/devices.js', './manifest.webmanifest'];
